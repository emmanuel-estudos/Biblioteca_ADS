import{n as e,r as t}from"./lib-CrvGBhFj.js";var n=t();function r(t){let r={code:`code`,em:`em`,h1:`h1`,h2:`h2`,p:`p`,pre:`pre`,span:`span`,strong:`strong`,...e(),...t.components};return(0,n.jsxs)(n.Fragment,{children:[(0,n.jsx)(r.h1,{id:`a-sintaxe`,children:`A Sintaxe`}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-js`,children:[(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` banana = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Amarela"`}),`;\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` `,(0,n.jsx)(r.span,{className:`hljs-title class_`,children:`Banana`}),` = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Fruta"`}),`;
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Se eu colocar duas barras, o JS ignora tudo o que estiver nesta linha! É um comentário de uma linha.`}),`\r
\r
`,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`/* Se eu usar uma barra e um asterisco, \r
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// 1. Criamos a caixa e colocamos o valor 0 lá dentro`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` pontosDoJogo = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`0`}),`; \r
\r
`,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// 2. O jogador fez um gol! Vamos mudar o que está dentro da caixa:`}),`\r
pontosDoJogo = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`1`}),`;\r
\r
`,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// 3. Agora a nossa caixa "pontosDoJogo" vale 1!`}),`
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Criamos a caixa constante com o nome`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`const`}),` meuNome = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Mariana"`}),`;\r
\r
`,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Se você tentar fazer isso aqui embaixo, o robô vai reclamar:`}),`\r
meuNome = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Pedro"`}),`; `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// ❌ ERRO! O JS não deixa você mudar uma constante.`}),`
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-js`,children:[(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`const`}),` animalFavorito = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Cachorro"`}),`; `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Isso é um texto!`}),`
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` idade = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`9`}),`;         `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Número inteiro`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` precoDoDoce = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`2.50`}),`; `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// No JS, usamos ponto para centavos!`}),`
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` estaChovendo = `,(0,n.jsx)(r.span,{className:`hljs-literal`,children:`false`}),`;  `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Não, está um dia ensolarado!`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` temSobremesa = `,(0,n.jsx)(r.span,{className:`hljs-literal`,children:`true`}),`;   `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Sim, tem bolo de chocolate!`}),`
`]})}),`
...
`,(0,n.jsx)(r.pre,{children:(0,n.jsxs)(r.code,{className:`hljs language-JS`,children:[(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Desafio: Complete os dados do seu herói ou heroína!`}),`\r
\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`const`}),` nomeDoHeroi = `,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Super Dev"`}),`; `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// O nome nunca muda (const)`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` nivel = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`1`}),`;                   `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// O nível vai subir (let)`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`let`}),` pontosDeVida = `,(0,n.jsx)(r.span,{className:`hljs-number`,children:`100`}),`;          `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// A vida pode diminuir ou aumentar (let)`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-keyword`,children:`const`}),` temSuperPoder = `,(0,n.jsx)(r.span,{className:`hljs-literal`,children:`true`}),`;      `,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Sim ou Não? (Boolean)`}),`\r
\r
`,(0,n.jsx)(r.span,{className:`hljs-comment`,children:`// Instruções para o robô mostrar no console o nosso herói:`}),`\r
`,(0,n.jsx)(r.span,{className:`hljs-variable language_`,children:`console`}),`.`,(0,n.jsx)(r.span,{className:`hljs-title function_`,children:`log`}),`(`,(0,n.jsx)(r.span,{className:`hljs-string`,children:`"Herói criado com sucesso!"`}),`);\r
`,(0,n.jsx)(r.span,{className:`hljs-variable language_`,children:`console`}),`.`,(0,n.jsx)(r.span,{className:`hljs-title function_`,children:`log`}),`(nomeDoHeroi);
